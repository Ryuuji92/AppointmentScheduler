    ...
    class Connection
    {
        ...
        public void InsertCustomer(Customer customer)
        {
            ...
            if (this.OpenConnection() == true)
            {
                ...
                command.Parameters.AddWithValue("@address.createDate", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
                command.Parameters.AddWithValue("@address.createdBy", CalendarView.CurrentUser.UserName);
                command.Parameters.AddWithValue("@address.lastUpdate", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
                command.Parameters.AddWithValue("@address.lastUpdateBy", CalendarView.CurrentUser.UserName);
                command.ExecuteNonQuery();

                command.CommandText = query2;
                command.Parameters.AddWithValue("@customerName", customer.CustomerName);
                command.Parameters.AddWithValue("@customer.createDate", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
                command.Parameters.AddWithValue("@customer.createdBy", CalendarView.CurrentUser.UserName);
                command.Parameters.AddWithValue("@customer.lastUpdate", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
        ...
        public void InsertAppointment(string userName, int userID, Appointment appointment)
        {
            ...
            if (this.OpenConnection() == true)
            {
                ...
                command.Parameters.AddWithValue("@start", appointment.Start.ToString("yyyy-MM-dd HH:mm:ss"));
                command.Parameters.AddWithValue("@end", appointment.End.ToString("yyyy-MM-dd HH:mm:ss"));
        ...
        {
            string query = "UPDATE appointment SET appointment.customerId=@customerId, appointment.title=@title, appointment.description=@description, appointment.location=@location, appointment.contact=@contact, appointment.type=@type, appointment.url=@url, appointment.start=@start, appointment.end=@end, appointment.lastUpdate='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "', appointment.lastUpdateBy='" + userName + "' WHERE appointmentId='" + appointment.ID.ToString() + "'";
